...
import moveSelectionModule from 'lib/features/move-selection';
...
describe('features/move-selection', function() {
  ...
  describe('with custom config', function() {
    ...
    it('should use custom speed', function() {
      ...
      var keyboardConfig = {
        moveSelection: {
          keyboardMoveSpeed: CUSTOM_SPEED
        }
      };
    ...
    it('should use custom modified speed', function() {
      ...
      var keyboardConfig = {
        moveSelection: {
          keyboardMoveSpeedModified: CUSTOM_HIGH_SPEED
        }
      };
